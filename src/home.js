...
const HS1 = {"padding-left" : "5px", "font-weight" : "bold","font-size": "17pt","margin-top" : "4px"};
...
export function loadModule(smid)
{
   ...
   switch(smid)
   {
        ...
        case "M10102":
            ...
            break;
            case "M00101":
                module.src = "/appointment";
                titlebar.innerText = "Appointment";
                break;
        default:
            module.src = "";
            titlebar.innerText = "";
        ...
        return(
            <div className='full-height'>
                <div className='header'>
                    <label style={HS1}>Hospital Management System</label>
                ...
                Copyright @ ABC HOSPITAL MANAGEMENT SYSTEM All rights reserved.
                </div>
            </div>
        );
    }
