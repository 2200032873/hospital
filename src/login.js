...
function Login(){
    ...
    return(
        <div className='full-height'>
            <div id='header' className='loginheader'>Hospital Management System</div>
            ...
            <div id='footer' className='loginfooter'>Copyright @ ABC HOSPITAL MANAGEMENT SYSTEM All rights reserved.</div>
        </div>
    );
}
